...
public class Azure {
	...
	public static void main(String[] args) throws Exception {
		// To navigate to the site azure and accepting this as string
		String url = "https://azure.microsoft.com/en-in/";
		// To display the console output in readable manner and avoid timeouts
...
//      Now Launch the browser
        ...
        chromeprefs.put("download.default_directory", "E:\\TestLeaf\\sankar\\Downloads");
...
//      Select Container Instances
     	...
     	System.out.println("Containers Instance clicked");
     	Thread.sleep(3000);
     	
     	
//     	Click on Container Instance Added View
     	driver.findElement(By.xpath("//a[text()='View']")).click();
     	System.out.println("Container Instances view Clicked");
...
//     	Select Region as "South India"
     	...
     	state.selectByVisibleText("South India");
     	System.out.println("South Region selected from the dropdown list");
     	
     	
//     	Set the Duration as 180000 seconds
     	WebElement secs = driver.findElement(By.xpath("//input[@aria-label='Seconds']"));
     	secs.clear();
     	secs.sendKeys("80000");
     	
//     	Select the Memory as 4GB
		WebElement memoryElement = driver.findElement(By.xpath("//select[@name='memory']"));
		Select memory = new Select(memoryElement);
...
//		Enable SHOW DEV/TEST PRICING
		...
		System.out.println("Enable Show Dev/Test Pricing enabled");
		Thread.sleep(500);
...
//		Select Indian Rupee  as currency
		...
		//12 Print the Estimated monthly price. Use Regular expression concept here and extract the number
		Thread.sleep(500);
...
//		Verify the downloded file in the local folder
		File download = new File("C:\\Users\\Meenakshi\\Downloads\\ExportedEstimate.xlsx");
...
//		Navigate to Example Scenarios and Select CI/CD for Containers
		...
		Thread.sleep(500);
		WebElement cicd = driver.findElement(By.xpath("//button[@title='CI/CD for Containers']"));
		js.executeScript("arguments[0].click();", cicd);
...
//		Change the Currency as Indian Rupee
		WebElement curr = driver.findElement(By.xpath("//select[@class='select currency-dropdown']"));
		Select crrncy = new Select(curr);
		crrncy.selectByVisibleText("Indian Rupee (₹)");
		
//		Enable SHOW DEV/TEST PRICING. using Javascript we can enable the visible text.
...
//		Verify the downloded file in the local folder. Put a condition here		
		File fileCI = new File("E:\\TestLeaf\\sankar\\ExportedEstimate (1).xlsx");   
		if(fileCI.exists()) {        
