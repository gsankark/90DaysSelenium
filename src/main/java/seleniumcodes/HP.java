package seleniumcodes;
	...
	public class HP {
		...
		public static void main(String[] args) throws InterruptedException {
			...
			// To display the console output in readable manner. To remove timeout messages
...
//	      Launch the browser
			...
			Actions ac = new Actions(driver); //Use action for mouse over
...
//	      Hard Drive Capacity -->More than 1TB
	        ...
	        try {
	        	...
	        	System.out.println("icon is not Closed");
	        	e.printStackTrace();
	        }
